...
public:
	...
	*/
	...
	inline void SetUniform(int location, const std::vector<float>& v) {

		gl::Uniform1fv(location, (GLint) v.size(), v.data());

	}
	inline void SetUniform(int location, const Vector2& v) {
		gl::Uniform2f(location, v.X, v.Y);
	}
	inline void SetUniform(int location, const Vector3& v) {

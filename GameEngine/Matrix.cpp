...
Vector3 Matrix::operator*(Vector3& vect) {
	...
	result.X = (m00 * vect.X) + (m01 * vect.Y) + (m02 * vect.Z) + m03; // (m03 * vect.W) where vect.W is always 1
	result.Y = (m10 * vect.X) + (m11 * vect.Y) + (m12 * vect.Z) + m13; // (m13 * vect.W) where vect.W is always 1
	result.Z = (m20 * vect.X) + (m21 * vect.Y) + (m22 * vect.Z) + m23; // (m23 * vect.W) where vect.W is always 1
